...
with tab_auto:
    ...
    # 2. تصفية المعلمين المؤهلين والمتاحين فقط (يصلح + يرغب + معلم + غير مكلف)
    df_qualified = df_all[
        (df_all['ability'] == 'يصلح') & 
    ...
    # 3. استخراج المناطق التي يتوفر بها معلمون مستوفون للشروط فقط
    ...
    with col_a2:
        # تصفية الـ Pool بناءً على المناطق المختارة
        if selected_cities:
