...
<style>
.stApp, main, section, div[class*="st-"], [data-testid="stVerticalBlock"], [data-testid="stElementContainer"] { direction: rtl !important; text-align: right !important; }
...
try:
# ✅ تم إصلاح INSERT ليشمل school و city
...
a['exam_date'], a['exam_day'], a.get('school',''), a.get('city',''), a['timestamp'], st.session_state.username))
except: pass
conn.commit()
else:
...
temp_doc = Document(TEMPLATE_NAME)
# ✅ تم إصلاح المفاتيح لتتطابق مع أسماء الأعمدة في قاعدة البيانات
repls = {
'ZNAME': str(a.get('teacher_name', '---') or '---'),
'ZID': str(a.get('teacher_id', '---') or '---'),  # ✅ تصحيح رقم الهوية
'ZTEST': str(a.get('exam_name', '---') or '---'),
'ZHALL': str(a.get('hall_name', '---') or '---'),
'ZLOC': str(a.get('hall_city', '---') or '---'),
'ZWORK': str(a.get('school', '---') or '---'),     # ✅ تصحيح المدرسة
'ZSCHOOL': str(a.get('school', '---') or '---'),
'ZCITY': str(a.get('city', '---') or '---'),       # ✅ تصحيح السكن
